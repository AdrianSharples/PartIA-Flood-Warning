...
"""This module provides interface for extracting statiob data from JSON
objects fetched from the Internet and
...
def build_station_list(use_cache=True):
    ...
    for e in data["items"]:
        ...
        try:
            # Create station object if all required data is available,
            # and add to list
            s = MonitoringStation(
                station_id=e['@id'],
